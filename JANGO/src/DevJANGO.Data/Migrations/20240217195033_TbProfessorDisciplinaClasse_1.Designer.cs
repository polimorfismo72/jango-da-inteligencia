...
namespace DevJANGO.Data.Migrations
{
    ...
    [Migration("20240217195033_TbProfessorDisciplinaClasse_1")]
    partial class TbProfessorDisciplinaClasse_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevJANGO.Business.Models.AlunoInscrito", b =>
                {
                    ...
                    b.Property<string>("NumPautaDaEscolaOrigem")
                        .IsRequired()
            ...
            modelBuilder.Entity("DevJANGO.Business.Models.PagamentoPropinaItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PropinaId");

                    b.ToTable("PagamentoPropinaItems", (string)null);
                });
            ...
            modelBuilder.Entity("DevJANGO.Business.Models.PagamentoPropinaItem", b =>
                {
                    b.HasOne("DevJANGO.Business.Models.FuncionarioCaixa", "FuncionarioCaixa")
                        .WithMany("PagamentoPropinaItems")
                        .HasForeignKey("FuncionarioCaixaId")
                        .IsRequired();
                    ...
                    b.HasOne("DevJANGO.Business.Models.Propina", "Propina")
                        .WithMany()
                        .HasForeignKey("PropinaId")
                        .IsRequired();
            ...
            modelBuilder.Entity("DevJANGO.Business.Models.FuncionarioCaixa", b =>
                {
                    ...
                    b.Navigation("PagamentoPropinaItems");
                });
